    ...
    describe('Sending Tokens', () => {
        ...
        describe('Success', () => {
            beforeEach(async () => {
                ...
                result = await transaction.wait(); // waits for the transaction to get included in the block
            })
    
            it('sending token balances', async () => {
        ...
        describe('Approving Tokens', () => {
            ...
            describe('Success', () => {
                it('allocations an allowance delegated token spending', async () => {
        ...
        describe('Delegated Token Transfers', () => {
            ...
            describe('Failure', async () => {
                it('attempt to transfer with invalid amount of tokens', async () => {
                    const invalidAmount = tokens(100000000000) // more tokens than is possible to send
